document.addEventListener('DOMContentLoaded', () => {
  ...
  function buildProjectKnowledge(projects) {
    ...
    return {
      ...
      'eeuez-menu': {
        ...byId['eeuez-menu'],
        aliases: [/\beeuez menu\b/, /\beeuez-menu\b/, /\bmenu qr\b/, /\bqr code\b/, /\brestaurant\b/, /\breservation\b/, /\blivraison\b/],
        stack: ['SaaS', 'hospitality', 'Agent IA', 'QR'],
        detail: "EEUEZ-Menu est une suite SaaS pour restaurants : Agent IA pour les réservations et les plats, menu en ligne, commandes et livraisons — avec QR codes intégrés.",
        impact: "Le projet couvre l'ensemble du parcours client restaurant, de la réservation à la livraison, avec un Agent IA au cœur.",
      },
      'le-greffulhe': {
        ...byId['le-greffulhe'],
        aliases: [/\bgreffulhe\b/, /\ble greffulhe\b/],
        stack: ['web sur mesure', 'restaurant', 'Uniiti'],
        detail: "Site vitrine restaurant développé en collaboration avec Uniiti — design sur mesure, menu en ligne et expérience client optimisée.",
        impact: "Fait partie d'une collaboration avec Uniiti pour des sites restaurant en France.",
      },
      'chez-mademoiselle-paris': {
        ...byId['chez-mademoiselle-paris'],
        aliases: [/\bmademoiselle\b/, /\bchez mademoiselle\b/],
        stack: ['web sur mesure', 'restaurant', 'Uniiti'],
        detail: "Site restaurant développé en collaboration avec Uniiti — identité visuelle forte, présentation des plats et réservation en ligne.",
        impact: "Collaboration Uniiti pour un restaurant parisien avec une forte identité de marque.",
      },
      'mazars-strasbourg-schiltigheim': {
        ...byId['mazars-strasbourg-schiltigheim'],
        aliases: [/\bmazars\b/, /\bstrasbourg\b/, /\bschiltigheim\b/],
        stack: ['web sur mesure', 'restaurant', 'Uniiti'],
        detail: "Site web sur mesure développé en collaboration avec Uniiti pour la restauration alsacienne.",
        impact: "Collaboration Uniiti dans le secteur de la restauration en Alsace.",
      },
      'mubaku-hightech': {
